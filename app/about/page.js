      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="rounded-2xl overflow-hidden h-64 relative">
            <Image src="/images/about-4.jpg" alt="" fill className="object-cover" sizes="400px" />
          </div>
          <div className="rounded-2xl overflow-hidden h-64 relative mt-6">
            <Image src="/images/about-1.webp" alt="" fill className="object-cover" sizes="400px" />
          </div>
          <div className="rounded-2xl overflow-hidden h-64 relative">
            <Image src="/images/about-2.jpg" alt="" fill className="object-cover" sizes="400px" />
          </div>
          <div className="rounded-2xl overflow-hidden h-64 relative mt-6">
            <Image src="/images/about-3.jpg" alt="" fill className="object-cover" sizes="400px" />
          </div>
        </div>
      </section>
