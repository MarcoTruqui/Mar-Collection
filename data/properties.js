const properties = [
...

  {
    ...
    description: `Villa Girasol is MAR Collection's flagship Bucerías property — a magnificent beachfront estate sitting directly on the sand with unobstructed Pacific views from nearly every room. Named for the sunflowers that line its entrance, Villa Girasol radiates warmth and elegance in equal measure.
...
Un carrito de golf está incluido en cada estadía, dándote la libertad de explorar las legendarias playas, campos de golf de clase mundial, spas y restaurantes frente al mar de Punta Mita.`,
...

  {
    ...
    cleaningFee: 120,
    serviceFee: 55,
    shortDescription: 'Spacious 2-bedroom ocean-view residence in the exclusive Zantamar complex — 1 king, 2 queens, pull-out sofa, up to 6 guests.',
    shortDescriptionEs: 'Amplia residencia de 2 habitaciones con vista al océano en el exclusivo complejo Zantamar — 1 king, 2 queens, sofá cama, hasta 6 huéspedes.',
...
La alberca, jardines y ambiente sereno del complejo Zantamar ofrecen un entorno de calidad resort, mientras que la famosa marina, el mercado y la escena gastronómica de La Cruz están a la vuelta de la esquina.`,
...

  {
    ...
    description: `Zantamar 305D is a spacious two-bedroom, ocean-view residence on the third floor of the Zantamar complex in La Cruz de Huanacaxtle. Designed for families or groups of up to 6, the unit offers a master bedroom with king bed, a second bedroom with two queen beds, a pull-out sofa in the living area, and two full bathrooms — a generous layout that rarely feels crowded.
...
The private terrace frames panoramic views of Banderas Bay, while the Zantamar complex's resort-quality pool and grounds provide an exceptional amenity backdrop. La Cruz's authentic village charm — the Friday market, whale watching, the marina — completes the picture.`,
    descriptionEs: `Zantamar 305D es una espaciosa residencia de dos habitaciones con vista al océano en el tercer piso del complejo Zantamar en La Cruz de Huanacaxtle. Diseñada para familias o grupos de hasta 6 personas, la unidad ofrece habitación principal con cama king, segunda habitación con dos camas queen, sofá cama en la sala y dos baños completos — una distribución generosa que rara vez se siente saturada.
