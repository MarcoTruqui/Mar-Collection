const properties = [
...

  {
    ...
    description: `Villa Girasol is TC Collection's flagship Bucerías property — a magnificent beachfront estate sitting directly on the sand with unobstructed Pacific views from nearly every room. Named for the sunflowers that line its entrance, Villa Girasol radiates warmth and elegance in equal measure.

The generous open-plan living and dining area opens directly to a private pool terrace and, beyond it, the beach itself — one of the most beloved stretches of sand in all of Nayarit. Four beautifully appointed bedroom suites accommodate up to 12 guests in total comfort, each finished with high-quality linens, ensuite bathrooms, and its own character.
...
Con las calles empedradas, galerías de arte y afamados restaurantes de mariscos de Bucerías a pocos pasos, Villa Girasol ofrece privacidad total y serenidad frente al mar con un pueblo vibrante a la vuelta de la esquina.`,
    amenities: ['Beachfront — Direct Beach Access', 'Private Pool', 'Ocean Views', 'Air Conditioning', 'High-Speed WiFi', 'Fully Equipped Kitchen', 'Outdoor Dining Area', 'Multiple Terraces', 'Smart TV / Streaming', 'Washer & Dryer', 'Covered Parking', 'Daily Housekeeping', 'BBQ Grill', 'Outdoor Shower', 'Concierge Service'],
    amenitiesEs: ['Frente al mar — Acceso directo a la playa', 'Alberca privada', 'Vistas al océano', 'Aire acondicionado', 'WiFi de alta velocidad', 'Cocina totalmente equipada', 'Área de comedor exterior', 'Múltiples terrazas', 'Smart TV / Streaming', 'Lavadora y secadora', 'Estacionamiento techado', 'Limpieza diaria', 'Asador', 'Regadera exterior', 'Servicio de concierge'],
    images: Array.from({length: 56}, (_, i) => `/images/villa-girasol/girasol_${String(i+1).padStart(2,'0')}.jpg`),
  },
...
Villa Jaguar está a minutos del famoso malecón de Bucerías, el paseo de arte del sábado y una escena gastronómica que atrae a gourmets de todo México.`,
    ...
    images: Array.from({length: 37}, (_, i) => `/images/villa-jaguar/jaguar_${String(i+1).padStart(2,'0')}.jpg`),
  },

  {
    ...
    description: `Villa Turquesa occupies a world of its own — a spectacular penthouse-level villa in Bucerías that delivers panoramic Pacific views, five private suites, and an entertainment experience that rivals the finest boutique hotels on the coast. Named for the turquoise waters that shimmer from every terrace, this is the ultimate address for large groups and milestone celebrations.
...
Ideal para bodas, reuniones familiares, cumpleaños especiales y cualquier ocasión que merezca ser recordada.`,
    amenities: ['Penthouse Level — Panoramic Views', 'Rooftop Pool', 'Ocean & Mountain Views', 'Air Conditioning', 'High-Speed WiFi', 'Professional Kitchen', 'Rooftop Terrace & Lounge', 'Multiple Living Areas', 'Smart TV / Streaming', 'Washer & Dryer', 'Secure Parking', 'Daily Housekeeping', 'Concierge Service', 'Event-Friendly Layout'],
    amenitiesEs: ['Nivel penthouse — Vistas panorámicas', 'Alberca en azotea', 'Vistas al océano y montañas', 'Aire acondicionado', 'WiFi de alta velocidad', 'Cocina profesional', 'Terraza y salón en azotea', 'Múltiples salas de estar', 'Smart TV / Streaming', 'Lavadora y secadora', 'Estacionamiento seguro', 'Limpieza diaria', 'Servicio de concierge', 'Distribución para eventos'],
    images: Array.from({length: 45}, (_, i) => `/images/villa-turquesa/turquesa_${String(i+1).padStart(2,'0')}.jpg`),
  },
...
El malecón vibrante de Bucerías, el paseo de arte del sábado y la celebrada escena de mariscos están a pocos pasos, haciendo de Villa Pelícano la base ideal para quienes buscan lo mejor de la vida auténtica en Nayarit.`,
    ...
    images: [
      '/images/villa-pelicano/pelicano-01.jpg',
      '/images/villa-pelicano/pelicano-02.jpg',
      ...Array.from({length: 42}, (_, i) => `/images/villa-pelicano/pelicano-${String(i+4).padStart(2,'0')}.jpg`),
    ],
  },

  {
    ...
    description: `Villa Perico is a vibrant, character-filled retreat in Bucerías — a three-bedroom villa that embodies the color, warmth, and joy of the Mexican Pacific coast. Named for the bright parrots that fill the Nayarit canopy, Villa Perico is bold, beautiful, and full of life.

The private pool and outdoor terrace are the heart of the property — a sun-drenched space perfectly designed for lazy mornings, poolside lunches, and golden-hour cocktails. Inside, the interiors are rich with handcrafted Mexican details: Talavera tiles, hand-painted accents, and artisan furnishings that make every corner a discovery.
...
Three comfortable suites accommodate up to 8 guests, each with their own ensuite bathroom and thoughtfully chosen finishes. Bucerías' cobblestone streets, art galleries, and world-class seafood are steps from your door.`,
    descriptionEs: `Villa Perico es un refugio vibrante y lleno de carácter en Bucerías — una villa de tres habitaciones que encarna el color, la calidez y la alegría de la costa del Pacífico mexicano. Su nombre evoca los brillantes pericos que llenan el dosel de Nayarit.

La alberca privada y la terraza exterior son el corazón de la propiedad — un espacio bañado por el sol, diseñado para mañanas tranquilas, almuerzos junto a la alberca y cócteles al atardecer. Por dentro, los interiores están llenos de detalles artesanales mexicanos: azulejos de Talavera, acentos pintados a mano y muebles artesanales que hacen de cada rincón un descubrimiento.
...
Tres cómodas suites alojan hasta 8 huéspedes, cada una con baño privado y acabados cuidadosamente elegidos. Las calles empedradas, galerías de arte y mariscos de clase mundial de Bucerías están a la vuelta de la esquina.`,
    ...
    images: Array.from({length: 39}, (_, i) => `/images/villa-perico/perico_perico_${String(i+1).padStart(2,'0')}.jpg`),
  },

  {
    ...
    cleaningFee: 170,
    serviceFee: 85,
    shortDescription: 'Graceful 4-bedroom villa in Bucerías named for the mockingbird — a property with many faces and one consistent quality: excellence.',
    shortDescriptionEs: 'Elegante villa de 4 habitaciones en Bucerías, nombrada por el cenzontle — una propiedad con muchas facetas y una constante: la excelencia.',
    description: `Villa Zenzontle takes its name from the zenzontle — the mockingbird of Mexican legend, a bird celebrated for its ability to be many things at once. This four-bedroom villa in Bucerías lives up to its name: intimate enough for couples traveling together, spacious enough for families, elegant enough for the most discerning guests.

The property centers on a generous private pool surrounded by tropical gardens, with outdoor living spaces designed for the long, golden days that define a Riviera Nayarit vacation. The interiors balance contemporary comfort with warm Mexican character — open-plan living, a fully equipped kitchen, and four private suites that each feel like their own retreat.
...
Situated in a quiet neighborhood just steps from Bucerías' vibrant town center, Villa Zenzontle offers the rare combination of total peace and instant access to the best of the coast.`,
    descriptionEs: `Villa Zenzontle toma su nombre del cenzontle — el pájaro de la leyenda mexicana, celebrado por su capacidad de ser muchas cosas a la vez. Esta villa de cuatro habitaciones en Bucerías está a la altura de su nombre: íntima para parejas que viajan juntas, espaciosa para familias, elegante para los huéspedes más exigentes.

La propiedad gira en torno a una generosa alberca privada rodeada de jardines tropicales, con espacios al aire libre diseñados para los largos y dorados días que definen unas vacaciones en la Riviera Nayarit. Los interiores equilibran la comodidad contemporánea con el carácter mexicano — sala abierta, cocina totalmente equipada y cuatro suites privadas que se sienten como un refugio propio.
...
Ubicada en un tranquilo vecindario a pocos pasos del vibrante centro de Bucerías, Villa Zenzontle ofrece la combinación perfecta de paz total y acceso inmediato a lo mejor de la costa.`,
    ...
    images: Array.from({length: 46}, (_, i) => `/images/villa-zenzontle/villa-zenzontle-${String(i+1).padStart(2,'0')}.jpg`),
  },
...

  {
    ...
    description: `Palmas 8 is one of Punta Mita's most coveted private estates — a four-bedroom sanctuary where the architecture speaks in the language of the palms, the ocean breeze, and the unhurried pace of the Mexican Pacific. Set within a prestigious gated community on the Punta Mita peninsula, this property delivers privacy, elegance, and privileged access to one of the world's most celebrated coastlines.
...
A complimentary golf cart is included with your stay — the ideal way to explore Punta Mita's beaches, beach clubs, and seaside restaurants at your own pace.`,
    descriptionEs: `Palmas 8 es una de las residencias privadas más codiciadas de Punta Mita — un santuario de cuatro habitaciones donde la arquitectura habla el idioma de las palmeras, la brisa marina y el ritmo pausado del Pacífico mexicano. Ubicada dentro de una exclusiva comunidad privada en la península de Punta Mita, esta propiedad ofrece privacidad, elegancia y acceso privilegiado a una de las costas más celebradas del mundo.
...
Un carrito de golf está incluido con tu estadía — la forma ideal de explorar las playas, beach clubs y restaurantes frente al mar de Punta Mita a tu propio ritmo.`,
    ...
    images: Array.from({length: 53}, (_, i) => `/images/palmas-8/palmas_${String(i+1).padStart(2,'0')}.jpg`),
  },

  {
    ...
    cleaningFee: 250,
    serviceFee: 150,
    shortDescription: 'Grand 5-bedroom Punta Mita estate with breathtaking ocean views, a private pool, and a golf cart — the pinnacle of peninsula living.',
    shortDescriptionEs: 'Gran residencia de 5 habitaciones en Punta Mita con impresionantes vistas al océano, alberca privada y carrito de golf — la cúspide del lujo en la península.',
    description: `Las Terrazas G-32 is the crown jewel of our Punta Mita collection — a grand five-bedroom estate that defines luxury living on the Mexican Pacific. Perched within an exclusive gated community on the Punta Mita peninsula, this property commands sweeping ocean views from its signature multi-level terraces, delivering some of the most spectacular scenery on the entire Riviera Nayarit.
...
Un carrito de golf está incluido en cada estadía, dándote la libertad de explorar las legendarias playas, campos de golf de clase mundial, spas y restaurantes frente al mar de Punta Mita.`,
    ...
    images: Array.from({length: 47}, (_, i) => `/images/terrazas-g32/terrazas_${String(i+1).padStart(2,'0')}.jpg`),
  },

  // ─────────────────────────────────────────────────────────────────────────
  // LA CRUZ DE HUANACAXTLE — Zantamar Complex
  // ─────────────────────────────────────────────────────────────────────────

  {
    ...
    maxGuests: 8,
    studio: false,
    sleeping: '1 king bed · 2 queen beds · pull-out sofa',
    nightlyRate: 320,
    cleaningFee: 120,
    serviceFee: 55,
    shortDescription: 'Spacious 2-bedroom ocean-view residence in the exclusive Zantamar complex — 1 king, 2 queens, pull-out sofa, up to 8 guests.',
    shortDescriptionEs: 'Amplia residencia de 2 habitaciones con vista al océano en el exclusivo complejo Zantamar — 1 king, 2 queens, sofá cama, hasta 8 huéspedes.',
    description: `Zantamar 205B is one of the larger residences in the prestigious Zantamar complex — a two-bedroom, ocean-view retreat that comfortably accommodates up to 8 guests with a thoughtful sleeping arrangement: a master with king bed, a second bedroom with two queen beds, and a pull-out sofa in the living room.

Perched above the charming marina village of La Cruz de Huanacaxtle, the unit enjoys sweeping views of Banderas Bay from its private terrace. The Zantamar complex is known for its resort-quality pool, lush grounds, and serene atmosphere — the ideal complement to La Cruz's beloved Friday market, live music at Philo's, world-class whale watching, and some of the finest fresh seafood in Mexico.`,
    descriptionEs: `Zantamar 205B es una de las residencias más amplias del prestigioso complejo Zantamar — un refugio de dos habitaciones con vista al océano que aloja cómodamente hasta 8 huéspedes: habitación principal con cama king, segunda habitación con dos camas queen y sofá cama en la sala.

Elevada sobre el encantador pueblo marina de La Cruz de Huanacaxtle, la unidad disfruta de amplias vistas a la Bahía de Banderas desde su terraza privada. El complejo Zantamar es conocido por su alberca de calidad resort, jardines exuberantes y ambiente sereno — el complemento ideal para el querido mercado del viernes de La Cruz, la música en vivo en Philo's, el avistamiento de ballenas y algunos de los mejores mariscos frescos de México.`,
    ...
    images: Array.from({length: 20}, (_, i) => `/images/zantamar-205b/zantamar205_${String(i+1).padStart(2,'0')}.jpg`),
  },

  {
    ...
    cleaningFee: 100,
    serviceFee: 50,
    shortDescription: 'Ocean-view studio at Zantamar in La Cruz de Huanacaxtle — king bed, bunk bed, 2 baths, up to 4 guests. Resort pool included.',
    shortDescriptionEs: 'Studio con vista al océano en Zantamar, La Cruz de Huanacaxtle — cama king, literas, 2 baños, hasta 4 huéspedes. Alberca de resort incluida.',
...
The open-plan layout makes clever use of every square foot — stylish, well-equipped, and filled with natural light and ocean breeze. Access to the Zantamar complex's resort-quality pool and lush grounds is included, making every day feel like a luxury stay at a boutique Pacific hotel.

La Cruz's marina, Friday organic market, Philo's live music, and world-class whale watching are all a short walk away.`,
    descriptionEs: `Zantamar 303D es un studio bellamente decorado con vista al océano en el tercer piso del prestigioso complejo Zantamar en La Cruz de Huanacaxtle. Íntimo pero completo, el studio cuenta con cama king, literas, dos baños completos y una terraza privada con amplias vistas a la Bahía de Banderas.

La distribución de planta abierta aprovecha inteligentemente cada metro cuadrado — elegante, bien equipado y lleno de luz natural y brisa marina. El acceso a la alberca de calidad resort y los jardines del complejo Zantamar está incluido, haciendo que cada día se sienta como una estadía de lujo en un hotel boutique frente al Pacífico.
...
La marina de La Cruz, el mercado orgánico del viernes, la música en vivo de Philo's y el avistamiento de ballenas están a pocos pasos.`,
    ...
    images: Array.from({length: 19}, (_, i) => `/images/zantamar-303d/zantamar303_${String(i+1).padStart(2,'0')}.jpg`),
  },

  {
    ...
    shortDescription: 'Ocean-view studio at Zantamar in La Cruz de Huanacaxtle — king bed, bunk bed, 2 baths, up to 4 guests. Resort pool included.',
    shortDescriptionEs: 'Studio con vista al océano en Zantamar, La Cruz de Huanacaxtle — cama king, literas, 2 baños, hasta 4 huéspedes. Alberca de resort incluida.',
    description: `Zantamar 304D is a refined ocean-view studio on the third floor of the Zantamar complex in La Cruz de Huanacaxtle. The studio layout — king bed, bunk bed, two bathrooms, and a private terrace overlooking Banderas Bay — is designed for the couple or small group who wants the character and warmth of La Cruz with the polish of a TC Collection property.
...
The Zantamar complex's pool, gardens, and serene atmosphere provide a resort-quality backdrop, while La Cruz's famous marina, market, and seafood scene are right at your doorstep.`,
    descriptionEs: `Zantamar 304D es un refinado studio con vista al océano en el tercer piso del complejo Zantamar en La Cruz de Huanacaxtle. La distribución del studio — cama king, literas, dos baños y terraza privada con vistas a la Bahía de Banderas — está diseñada para la pareja o grupo pequeño que busca el carácter y la calidez de La Cruz con el acabado de una propiedad TC Collection.
...
La alberca, jardines y ambiente sereno del complejo Zantamar ofrecen un entorno de calidad resort, mientras que la famosa marina, el mercado y la escena gastronómica de La Cruz están a la vuelta de la esquina.`,
    amenities: ['Ocean View', 'Private Terrace', 'Complex Pool', 'King Bed + Bunk Bed', '2 Bathrooms', 'Air Conditioning', 'High-Speed WiFi', 'Fully Equipped Kitchen', 'Marina (walking distance)', 'Smart TV / Streaming', 'Washer & Dryer', 'Secure Parking', 'Daily Housekeeping'],
    amenitiesEs: ['Vista al océano', 'Terraza privada', 'Alberca del complejo', 'Cama king + literas', '2 baños', 'Aire acondicionado', 'WiFi de alta velocidad', 'Cocina totalmente equipada', 'Marina (a pie)', 'Smart TV / Streaming', 'Lavadora y secadora', 'Estacionamiento seguro', 'Limpieza diaria'],
    images: Array.from({length: 22}, (_, i) => `/images/zantamar-304d/zantamar304_${String(i+1).padStart(2,'0')}.jpg`),
  },

  {
    ...
    cleaningFee: 120,
    serviceFee: 55,
    shortDescription: 'Spacious 2-bedroom ocean-view residence at Zantamar — 1 king, 2 queens, pull-out sofa, up to 8 guests in La Cruz de Huanacaxtle.',
    shortDescriptionEs: 'Amplia residencia de 2 habitaciones con vista al océano en Zantamar — 1 king, 2 queens, sofá cama, hasta 8 huéspedes en La Cruz de Huanacaxtle.',
    description: `Zantamar 305D is a spacious two-bedroom, ocean-view residence on the third floor of the Zantamar complex in La Cruz de Huanacaxtle. Designed for families or groups of up to 8, the unit offers a master bedroom with king bed, a second bedroom with two queen beds, a pull-out sofa in the living area, and two full bathrooms — a generous layout that rarely feels crowded.

The private terrace frames panoramic views of Banderas Bay, while the Zantamar complex's resort-quality pool and grounds provide an exceptional amenity backdrop. La Cruz's authentic village charm — the Friday market, whale watching, the marina — completes the picture.`,
    descriptionEs: `Zantamar 305D es una espaciosa residencia de dos habitaciones con vista al océano en el tercer piso del complejo Zantamar en La Cruz de Huanacaxtle. Diseñada para familias o grupos de hasta 8 personas, la unidad ofrece habitación principal con cama king, segunda habitación con dos camas queen, sofá cama en la sala y dos baños completos — una distribución generosa que rara vez se siente saturada.

La terraza privada enmarca vistas panorámicas a la Bahía de Banderas, mientras que la alberca de calidad resort y los jardines del complejo Zantamar ofrecen un entorno excepcional. El encanto auténtico del pueblo de La Cruz — el mercado del viernes, el avistamiento de ballenas, la marina — completa el cuadro.`,
    amenities: ['Ocean View', 'Private Terrace', 'Complex Pool', '2 Bedrooms (King + 2 Queens)', 'Pull-Out Sofa', 'Air Conditioning', 'High-Speed WiFi', 'Fully Equipped Kitchen', 'Marina (walking distance)', 'Smart TV / Streaming', 'Washer & Dryer', 'Secure Parking', 'Daily Housekeeping', 'Concierge Service'],
    amenitiesEs: ['Vista al océano', 'Terraza privada', 'Alberca del complejo', '2 habitaciones (King + 2 Queens)', 'Sofá cama', 'Aire acondicionado', 'WiFi de alta velocidad', 'Cocina totalmente equipada', 'Marina (a pie)', 'Smart TV / Streaming', 'Lavadora y secadora', 'Estacionamiento seguro', 'Limpieza diaria', 'Servicio de concierge'],
    images: Array.from({length: 30}, (_, i) => `/images/zantamar-305d/zantamar305_${String(i+1).padStart(2,'0')}.jpg`),
  },

  {
    ...
    shortDescription: 'Ocean-view studio at Zantamar in La Cruz de Huanacaxtle — king bed, bunk bed, 2 baths, up to 4 guests. Resort pool included.',
    shortDescriptionEs: 'Studio con vista al océano en Zantamar, La Cruz de Huanacaxtle — cama king, literas, 2 baños, hasta 4 huéspedes. Alberca de resort incluida.',
    description: `Zantamar 306D is an ocean-view studio at the Zantamar complex in La Cruz de Huanacaxtle — a beautifully appointed retreat with a king bed, bunk bed, two bathrooms, and a private terrace with panoramic Banderas Bay views.
...
Compact, stylish, and complete, this studio is perfect for a couple or small family seeking the quintessential La Cruz experience at an accessible price point, with the full amenity backdrop of the Zantamar complex and TC Collection concierge service included.`,
    descriptionEs: `Zantamar 306D es un studio con vista al océano en el complejo Zantamar en La Cruz de Huanacaxtle — un refugio bellamente decorado con cama king, literas, dos baños y terraza privada con vistas panorámicas a la Bahía de Banderas.
...
Compacto, elegante y completo, este studio es perfecto para una pareja o familia pequeña que busca la experiencia quintaesencial de La Cruz a un precio accesible, con el respaldo total de las amenidades del complejo Zantamar y el servicio de concierge de TC Collection incluidos.`,
    amenities: ['Ocean View', 'Private Terrace', 'Complex Pool', 'King Bed + Bunk Bed', '2 Bathrooms', 'Air Conditioning', 'High-Speed WiFi', 'Fully Equipped Kitchen', 'Marina (walking distance)', 'Smart TV / Streaming', 'Washer & Dryer', 'Secure Parking', 'Daily Housekeeping'],
    amenitiesEs: ['Vista al océano', 'Terraza privada', 'Alberca del complejo', 'Cama king + literas', '2 baños', 'Aire acondicionado', 'WiFi de alta velocidad', 'Cocina totalmente equipada', 'Marina (a pie)', 'Smart TV / Streaming', 'Lavadora y secadora', 'Estacionamiento seguro', 'Limpieza diaria'],
    images: Array.from({length: 23}, (_, i) => `/images/zantamar-306d/zantamar306_${String(i+1).padStart(2,'0')}.jpg`),
  },

  {
    ...
    maxGuests: 6,
    studio: false,
    sleeping: '1 king bed · 1 king bunk bed · pull-out sofa',
    nightlyRate: 480,
    cleaningFee: 160,
    serviceFee: 80,
    shortDescription: 'The crown of Zantamar — beachfront townhouse right on the sand with a private pool, 2 bedrooms, and Banderas Bay at your feet.',
    shortDescriptionEs: 'La joya de Zantamar — townhouse frente al mar directamente sobre la arena con alberca privada, 2 habitaciones y la Bahía de Banderas a tus pies.',
    description: `Zantamar TH7 is the crown jewel of the Zantamar complex — a rare beachfront townhouse sitting directly on the sand of La Cruz de Huanacaxtle with a private pool, sweeping bay views, and the kind of direct ocean access that simply doesn't exist at this price point anywhere on the Riviera Nayarit.

Two bedrooms — a master with king bed and a second room with a king-size bunk bed — plus a pull-out sofa in the living area accommodate up to 6 guests across a generous multi-level layout. Step off your private terrace directly onto the beach; walk into your private pool whenever the mood strikes.
...
TH7 delivers the intimacy and exclusivity of a private villa with the full amenity support of the Zantamar complex and TC Collection concierge service. It is, without question, the finest address in La Cruz.`,
    descriptionEs: `Zantamar TH7 es la joya de la corona del complejo Zantamar — un excepcional townhouse frente al mar ubicado directamente sobre la arena de La Cruz de Huanacaxtle, con alberca privada, amplias vistas a la bahía y el tipo de acceso directo al océano que sencillamente no existe a este precio en ningún lugar de la Riviera Nayarit.

Dos habitaciones — una principal con cama king y una segunda con literas king — más un sofá cama en la sala alojan hasta 6 huéspedes en una generosa distribución de varios niveles. Sal de tu terraza privada directamente a la playa; entra a tu alberca privada cuando el momento lo pida.
